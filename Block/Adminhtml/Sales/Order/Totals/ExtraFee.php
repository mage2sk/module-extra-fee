...
namespace Panth\ExtraFee\Block\Adminhtml\Sales\Order\Totals;
...
/**
 * Admin order view extra fee totals block.
 */
class ExtraFee extends Template
{
    ...
    /**
     * Initialize extra fee totals for the admin order view.
     *
     * @return $this
     */
