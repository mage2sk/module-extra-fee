<?php
/**
 * Standalone install + heartbeat reporter for Panth_ExtraFee.
 *
...
namespace Panth\ExtraFee\Service;
...
{
    public const MAGENTO_MODULE = 'Panth_ExtraFee';
    public const COMPOSER_PACKAGE = 'mage2kishan/module-extra-fee';
